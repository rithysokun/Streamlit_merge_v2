...
st.write("Rename the column to Date, City, Service for matching columns")

uploaded_file = st.file_uploader("Choose a file (Allocation Table, Count of total booking, complete order, cancelled) ")
...
second_file = st.file_uploader("Choose a second file (daily user table)", key="second_file")
...
third_file = st.file_uploader("Choose a third file (gmv)", key="third_file")
